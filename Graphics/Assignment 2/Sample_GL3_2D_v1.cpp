...
string inp_board[10];
float panx=-7.3,panz=-2.1,pany=0.1;
float eyefrom[3] = {5,5,5};
float targetto[3] = {0,0,0};
float target[3] = {0,0,0};
float act_eye[3] = {0,0,0};
float tilt[3] = {5,-10,2.5};
...
void draw ()
{
	...
	glm::vec3 eye (act_eye[0], act_eye[1], act_eye[2]);	// Target - Where is the camera looking at.  Don't change unless you are sure!!
	glm::vec3 target (target[1],target[2],target[3]);

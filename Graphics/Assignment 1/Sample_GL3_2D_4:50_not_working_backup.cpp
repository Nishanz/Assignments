...
void keyboardUp (GLFWwindow* window, unsigned int key)
{
	//cout<<key<<endl;
    switch (key) {
        case 'Q':
...
VAO *triangle, *rectangle, *canon, *bird1, *bird2, *bird3, *myrect[100], *pig[100];
int i=0,rectno=0,pigno=0;
float xc,yc;
...
void createcanon (GLdouble xx,GLdouble yy, GLdouble centrex,GLdouble centrey)
{
  /* ONLY vertices between the bounds specified in glm::ortho will be visible on screen */
    const double TWO_PI = 6.2831853;
    GLdouble hexTheta,x,y,radius,previousx,previousy;
...
GLFWwindow* initGLFW (int width, int height)
{
	...
	glfwSetCharCallback(window, keyboardUp);  // simpler specific character handling
